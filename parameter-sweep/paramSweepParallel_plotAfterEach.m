function [peakVals,mainComputationTime,nVals,hVals,aVals]=paramSweepParallel_plotAfterEach(nVals,hVals,aVals,L,showTruss, hTopAxes)
...
afterEach(D,@updatePlot);

parfor ii = 1:numel(nGrid)
